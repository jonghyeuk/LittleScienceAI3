...
# sac 구성 요소 대신 기본 streamlit 사용
def sac_menu(items, default=None, format_func=None, key=None):
    """
    streamlit_antd_components 메뉴 대체
    """
    return st.selectbox("메뉴", items, index=0 if default is None else items.index(default), 
